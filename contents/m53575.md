...
**Constant Multiple Rule**{: data-type="term"}. The derivative of a constant *k* multiplied by a function *f* is the same as the constant multiplied by the derivative: <math xmlns="http://www.w3.org/1998/Math/MathML" />
...
Suppose you are designing a new Formula One track. One section of the track can be modeled by the function <math xmlns="http://www.w3.org/1998/Math/MathML"><mrow><mi>f</mi><mrow><mo>(</mo><mi>x</mi><mo>)</mo></mrow><mo>=</mo><msup><mi>x</mi><mn>3</mn></msup><mo>+</mo><mn>3</mn><msup><mi>x</mi><mn>2</mn></msup><mo>+</mo><mi>x</mi></mrow></math>
...
<span data-type="media" data-alt="Two functions are graphed: f(x) and g(x). The function f(x) starts at (&#x2212;1, 5) and decreases linearly to (3, 1) at which point it increases linearly to (5, 3). The function g(x) starts at the origin, increases linearly to (2.5, 2.5), and then remains constant at y = 2.5."> ![Two functions are graphed: f(x) and g(x). The function f(x) starts at (&#x2212;1, 5) and decreases linearly to (3, 1) at which point it increases linearly to (5, 3). The function g(x) starts at the origin, increases linearly to (2.5, 2.5), and then remains constant at y = 2.5.](../resources/CNX_Calc_Figure_03_03_205.jpg) </span>
<div data-type="exercise">
<div data-type="problem" markdown="1">
