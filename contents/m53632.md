...
In addition, since *c* is between *x* and *x* + *h*, *c* approaches *x* as *h* approaches zero. Also, since <math xmlns="http://www.w3.org/1998/Math/MathML"><mrow><mi>f</mi><mrow><mo>(</mo><mi>x</mi><mo>)</mo></mrow></mrow></math>
...
[1]: http://www.openstax.org/l/20_newtonbio
