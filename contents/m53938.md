...
<div data-type="media" data-alt="A conical frustum (that is, a cone with the pointy end cut off) with height x, larger radius y, and smaller radius x.">
![A conical frustum (that is, a cone with the pointy end cut off) with height x, larger radius y, and smaller radius x.](../resources/CNX_Calc_Figure_14_05_201.jpg)
</div>
</div>
</div>
<div data-type="exercise">
