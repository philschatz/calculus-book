...
<span data-type="media" data-alt="This figure has a graph in the first quadrant. It increases to where x is approximately 03:00 mm:ss and then drops off steep. The maximum height of the graph, here the drop occurs is approximately 420 km/h."> ![This figure has a graph in the first quadrant. It increases to where x is approximately 03:00 mm:ss and then drops off steep. The maximum height of the graph, here the drop occurs is approximately 420 km/h.](../resources/CNX_Calc_Figure_07_07_201.jpg) </span>
</div>
</div>
...
[1]: http://www.openstax.org/l/20_GabrielsHorn
