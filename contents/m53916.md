...
<div data-type="media" data-alt="This figure is a 3 dimensional graph. It is a curve inside of a box. The curve starts at the bottom of the box and spirals around the middle, with upward orientation.">
![This figure is a 3 dimensional graph. It is a curve inside of a box. The curve starts at the bottom of the box and spirals around the middle, with upward orientation.](../resources/CNX_Calc_Figure_13_02_202.jpg)
</div>
</div>
<div data-type="solution" markdown="1">
...
<div data-type="media" data-alt="This figure has two graphs. The first graph is inside a 3 dimensional box. It has a lattice-look to the graph in the middle of the box, crossing over itself. The second graph is the same as the first, with a different position of the box for a different perspective of the lattice-looking curve.">
![This figure has two graphs. The first graph is inside a 3 dimensional box. It has a lattice-look to the graph in the middle of the box, crossing over itself. The second graph is the same as the first, with a different position of the box for a different perspective of the lattice-looking curve.](../resources/CNX_Calc_Figure_13_02_203.jpg)
</div>
</div>
</div>
<div data-type="exercise">
...
<div data-type="media" data-alt="This figure is a 3 dimensional graph. It is inside of a box. The box represents an octant. The curve in the graph starts at the lower left corner of the box and bends upward and out towards the other end of the box.">
![This figure is a 3 dimensional graph. It is inside of a box. The box represents an octant. The curve in the graph starts at the lower left corner of the box and bends upward and out towards the other end of the box.](../resources/CNX_Calc_Figure_13_02_204.jpg)
</div>
Find the following.
...
<div data-type="media" data-alt="This figure is the graph of a curve in 3 dimensions. The curve is inside of a box. The box represents an octant. The curve begins at the bottom of the box to the left and curves upward to the top right corner.">
![This figure is the graph of a curve in 3 dimensions. The curve is inside of a box. The box represents an octant. The curve begins at the bottom of the box to the left and curves upward to the top right corner.](../resources/CNX_Calc_Figure_13_02_207.jpg)
</div>
<div data-type="exercise">
<div data-type="problem" markdown="1">
...
<div data-type="media" data-alt="This figure is the graph of a curve in 3 dimensions. The curve is inside of a box. The box represents an octant. The curve is a helix and begins at the bottom of the box to the right and spirals upward.">
![This figure is the graph of a curve in 3 dimensions. The curve is inside of a box. The box represents an octant. The curve is a helix and begins at the bottom of the box to the right and spirals upward.](../resources/CNX_Calc_Figure_13_02_208.jpg)
</div>
Find the following:
...
<div data-type="media" data-alt="This figure is the graph of a curve in 3 dimensions. The curve is inside of a box. The box represents an octant. The curve has asymptotes that are the diagonals of the box. The curve is hyperbolic.">
![This figure is the graph of a curve in 3 dimensions. The curve is inside of a box. The box represents an octant. The curve has asymptotes that are the diagonals of the box. The curve is hyperbolic.](../resources/CNX_Calc_Figure_13_02_209.jpg)
</div>
<div data-type="exercise">
<div data-type="problem" markdown="1">
Velocity
...
<div data-type="media" data-alt="This figure is the graph of a hyperbolic curve. The y-axis is a vertical asymptote and the x-axis is the horizontal asymptote.">
![This figure is the graph of a hyperbolic curve. The y-axis is a vertical asymptote and the x-axis is the horizontal asymptote.](../resources/CNX_Calc_Figure_13_02_210.jpg)
</div>
</div>
<div data-type="solution" markdown="1">
