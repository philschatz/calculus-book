...
<div data-type="media" data-alt="The function begins at (&#x2212;3, 0.5) and decreases to a local minimum at (&#x2212;2.3, &#x2212;2). Then the function increases through (&#x2212;1.5, 0) and slows its increase through (0, 2). It then slowly increases to a local maximum at (2.3, 6) before decreasing to (3, 3).">
![The function begins at (&#x2212;3, 0.5) and decreases to a local minimum at (&#x2212;2.3, &#x2212;2). Then the function increases through (&#x2212;1.5, 0) and slows its increase through (0, 2). It then slowly increases to a local maximum at (2.3, 6) before decreasing to (3, 3).](../resources/CNX_Calc_Figure_03_09_204.jpg)
</div>
</div>
</div>
...
<div data-type="exercise">
<div data-type="problem">
<div data-type="media" data-alt="The function decreases linearly from (&#x2212;1, 4) to the origin, at which point it increases as x2, passing through (1, 1) and (2, 4).">
![The function decreases linearly from (&#x2212;1, 4) to the origin, at which point it increases as x2, passing through (1, 1) and (2, 4).](../resources/CNX_Calc_Figure_03_09_206.jpg)
</div>
</div>
<div data-type="solution" markdown="1">
* * *
