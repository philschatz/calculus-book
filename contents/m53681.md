...
<span data-type="media" data-alt="This figure is a graph of the function y = x/(1 + x). The graph is only in the first quadrant. It begins at the origin and increases into the first quadrant. The curve stops at x = 5."> ![This figure is a graph of the function y = x/(1 + x). The graph is only in the first quadrant. It begins at the origin and increases into the first quadrant. The curve stops at x = 5.](../resources/CNX_Calc_Figure_07_04_201.jpg) </span>
</div>
</div>
<div data-type="exercise">
<div data-type="problem" markdown="1">
