...
1.  Line
    ...
    * * *
    ...
    <div data-type="media" data-alt="This figure is the 3-dimensional coordinate system. There are two skew lines drawn. They do not intersect and are not parallel.">
    ![This figure is the 3-dimensional coordinate system. There are two skew lines drawn. They do not intersect and are not parallel.](../resources/CNX_Calc_Figure_12_05_011.jpg)
    </div>
...
2.  Line *L<sub>1</sub>* has direction vector
    ...
    * * *
    ...
    <div data-type="media" data-alt="This figure is the 3-dimensional coordinate system. There are two skew lines drawn. They do not intersect and are not parallel.">
    ![This figure is the 3-dimensional coordinate system. There are two skew lines drawn. They do not intersect and are not parallel.](../resources/CNX_Calc_Figure_12_05_012.jpg)
    </div>
...
3.  Lines
    ...
    * * *
    ...
    <div data-type="media" data-alt="This figure is the 3-dimensional coordinate system. There are two skew lines drawn. They do not intersect and are not parallel.">
    ![This figure is the 3-dimensional coordinate system. There are two skew lines drawn. They do not intersect and are not parallel.](../resources/CNX_Calc_Figure_12_05_013.jpg)
    </div>
{: data-number-style="lower-alpha"}
...
<div data-type="media" data-alt="This figure is the 3-dimensional coordinate system. There is a plane sketched. It is vertical, but skew to the z-axis.">
![This figure is the 3-dimensional coordinate system. There is a plane sketched. It is vertical, but skew to the z-axis.](../resources/CNX_Calc_Figure_12_05_014.jpg)
</div>
</div>
</div>
</div>
...
<div data-type="media" data-alt="This figure is the 3-dimensional coordinate system. There is a point drawn at (3, 1, 2). The point is labeled &#x201C;P(3, 1, 2).&#x201D; There is a plane drawn. There is a perpendicular line from the plane to point P(3, 1, 2).">
![This figure is the 3-dimensional coordinate system. There is a point drawn at (3, 1, 2). The point is labeled &#x201C;P(3, 1, 2).&#x201D; There is a plane drawn. There is a perpendicular line from the plane to point P(3, 1, 2).](../resources/CNX_Calc_Figure_12_05_015.jpg)
</div>
</div>
<div data-type="solution" markdown="1">
...
<div data-type="media" data-alt="This figure is two planes intersecting in the 3-dimensional coordinate system.">
![This figure is two planes intersecting in the 3-dimensional coordinate system.](../resources/CNX_Calc_Figure_12_05_016.jpg)
</div>
</div>
<div data-type="solution" markdown="1">
...
<div data-type="media" data-alt="This figure is the image of two children throwing a ball. The path of the ball is represented with an arc. The distance from the child throwing the ball to the point where the ball hits is 5 feet. The distance from the second child to where the ball hits is 3 feet.">
![This figure is the image of two children throwing a ball. The path of the ball is represented with an arc. The distance from the child throwing the ball to the point where the ball hits is 5 feet. The distance from the second child to where the ball hits is 3 feet.](../resources/CNX_Calc_Figure_12_05_205.jpg)
</div>
</div>
<div data-type="solution" markdown="1">
...
<div data-type="media" data-alt="This figure is a picture of a rectangular solar grid on a roof. The corners of the rectangle are labeled A, B, C, D. There are two vectors, the first is from A to D. The second is from A to B.">
![This figure is a picture of a rectangular solar grid on a roof. The corners of the rectangle are labeled A, B, C, D. There are two vectors, the first is from A to D. The second is from A to B.](../resources/CNX_Calc_Figure_12_04_214.jpg)
</div>
