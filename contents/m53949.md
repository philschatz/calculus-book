...
<div data-type="media" data-alt="A contour map is shown with the highest point being about 18 and centered near (4, negative 1). From this point, the values decrease to 16, 14, 12, 10, 8, and 6 roughly every 0.5 to 1 distance. The lowest point is negative four near (negative 3, 4). There is a local minimum of 2 near (negative 1, 0).">
![A contour map is shown with the highest point being about 18 and centered near (4, negative 1). From this point, the values decrease to 16, 14, 12, 10, 8, and 6 roughly every 0.5 to 1 distance. The lowest point is negative four near (negative 3, 4). There is a local minimum of 2 near (negative 1, 0).](../resources/CNX_Calc_Figure_15_01_010.jpg)
</div>
...
2.  Estimate the average value of the function *f* on *R*.
    * * *
    ...
    <div data-type="media" data-alt="A series of curves marked k = negative 1, negative &#xBD;, negative &#xBC;, negative 1/8, 0, 1/8, &#xBC;, &#xBD;, and 1. The line marked k = 0 serves as an asymptote along the line y = x. The lines originate at (along the y axis) 1, 0.7, 0.5, 0.38, 0, (along the x axis) 0.38, 0.5, 0.7, and 1, with the further out lines curving less dramatically toward the asymptote.">
    ![A series of curves marked k = negative 1, negative &#xBD;, negative &#xBC;, negative 1/8, 0, 1/8, &#xBC;, &#xBD;, and 1. The line marked k = 0 serves as an asymptote along the line y = x. The lines originate at (along the y axis) 1, 0.7, 0.5, 0.38, 0, (along the x axis) 0.38, 0.5, 0.7, and 1, with the further out lines curving less dramatically toward the asymptote.](../resources/CNX_Calc_Figure_15_01_201.jpg)
    </div>
{: data-number-style="lower-alpha"}
...
2.  Estimate the average value of the function *f* on *R*.
    * * *
    ...
    <div data-type="media" data-alt="A series of quarter circles drawn in the first quadrant marked k = 1/32, 1/16, 1/8, &#xBC;, &#xBD;, &#xBE;, and 1. The quarter circles have radii 0. 17, 0.25, 0.35, 0.5, 0.71, 0.87, and 1, respectively.">
    ![A series of quarter circles drawn in the first quadrant marked k = 1/32, 1/16, 1/8, &#xBC;, &#xBD;, &#xBE;, and 1. The quarter circles have radii 0. 17, 0.25, 0.35, 0.5, 0.71, 0.87, and 1, respectively.](../resources/CNX_Calc_Figure_15_01_202.jpg)
    </div>
{: data-number-style="lower-alpha"}
...
<div data-type="media" data-alt="A quarter cylinder with center along the x axis and with radius 2. It has height 2 as shown.">
![A quarter cylinder with center along the x axis and with radius 2. It has height 2 as shown.](../resources/CNX_Calc_Figure_15_01_203.jpg)
</div>
</div>
<div data-type="solution" markdown="1">
...
<div data-type="media" data-alt="In xyz space, a shape is created with sides given by y = 0, x = 0, y = 4, x = 2, z = 0, and the plane the runs from z = 4 along the y axis to z = 8 along the plane formed by y = 4.">
![In xyz space, a shape is created with sides given by y = 0, x = 0, y = 4, x = 2, z = 0, and the plane the runs from z = 4 along the y axis to z = 8 along the plane formed by y = 4.](../resources/CNX_Calc_Figure_15_01_204.jpg)
</div>
</div>
</div>
...
<div data-type="media" data-alt="A contour map showing surface temperature in degrees Fahrenheit. Given the map, the midpoint rule would give rectangles with values 71, 72, 40, and 43.">
![A contour map showing surface temperature in degrees Fahrenheit. Given the map, the midpoint rule would give rectangles with values 71, 72, 40, and 43.](../resources/CNX_Calc_Figure_15_01_209.jpg)
</div>
</div>
<div data-type="solution" markdown="1">
