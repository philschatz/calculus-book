...
3.  Is the work the same along the two paths?
    * * *
    ...
    <div data-type="media" data-alt="A curve and vector field in three dimensions. The curve segments go from (1,2,3) to (0,0,0) to (1,0,0) to (1,2,0), and the arrowheads point to (0,0,0), (1,0,0), and (1,2,0). The surrounding vectors are larger the more the z component increases.">
    ![A curve and vector field in three dimensions. The curve segments go from (1,2,3) to (0,0,0) to (1,0,0) to (1,2,0), and the arrowheads point to (0,0,0), (1,0,0), and (1,2,0). The surrounding vectors are larger the more the z component increases.](../resources/CNX_Calc_Figure_16_02_201.jpg)
    </div>
