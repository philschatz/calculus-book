...
<span data-type="media" data-alt="A three dimensional diagram of an object rotating about the x axis in a counterclockwise manner with constant angular velocity w = &lt;a,b,c&gt;. The object is roughly a sphere with pointed ends on the x axis, which cuts it in half. An arrow r is drawn from (0,0,0) to P(x,y,z) and down from P(x,y,z) to the x axis."> ![A three dimensional diagram of an object rotating about the x axis in a counterclockwise manner with constant angular velocity w = &lt;a,b,c&gt;. The object is roughly a sphere with pointed ends on the x axis, which cuts it in half. An arrow r is drawn from (0,0,0) to P(x,y,z) and down from P(x,y,z) to the x axis.](../resources/CNX_Calc_Figure_16_05_201.jpg) </span>
<div data-type="exercise">
<div data-type="problem" markdown="1">
...
<span data-type="media" data-alt="A three dimensional diagram of a rotational velocity field. The arrows are showing a rotation in a clockwise manner. A paddlewheel is shown in plan x + y + z = 1 with n extended out perpendicular to the plane."> ![A three dimensional diagram of a rotational velocity field. The arrows are showing a rotation in a clockwise manner. A paddlewheel is shown in plan x + y + z = 1 with n extended out perpendicular to the plane.](../resources/CNX_Calc_Figure_16_05_202.jpg) </span>
</div>
</div>
</section>
