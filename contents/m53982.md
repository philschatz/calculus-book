...
<span data-type="media" data-alt="A vector field in two dimensions. The arrows surround the origin in a clockwise circular motion. Those close to the origin are much smaller than those further away. A circle of radius 2 and a circle of radius with centers at the origin is drawn in, and the region between the two is shaded."> ![A vector field in two dimensions. The arrows surround the origin in a clockwise circular motion. Those close to the origin are much smaller than those further away. A circle of radius 2 and a circle of radius with centers at the origin is drawn in, and the region between the two is shaded.](../resources/CNX_Calc_Figure_16_04_202.jpg) </span>
</div>
</div>
<div data-type="exercise">
<div data-type="problem" markdown="1">
...
<span data-type="media" data-alt="A vector field in quadrant 1. The arrows are much smaller closer to the origin. They point up and away from the origin, with increasing slope the further they are to the right. The curve follows the parabola y=x^2 from the origin to (2,4), the line from (2,4) to (2,0), and the line from (2,0) to (0,0). The area under y=2x and above the parabola is shaded."> ![A vector field in quadrant 1. The arrows are much smaller closer to the origin. They point up and away from the origin, with increasing slope the further they are to the right. The curve follows the parabola y=x^2 from the origin to (2,4), the line from (2,4) to (2,0), and the line from (2,0) to (0,0). The area under y=2x and above the parabola is shaded.](../resources/CNX_Calc_Figure_16_04_203.jpg) </span>
</div>
<div data-type="solution" markdown="1">
...
<span data-type="media" data-alt="A vector field in two dimensions. The arrows are smaller the closer they are to the origin, particular vertically. Curve C follows a counterclockwise path around the region bounded by x=-1, x=2, y = 4-x^2, and y = x-2. The region is shaded."> ![A vector field in two dimensions. The arrows are smaller the closer they are to the origin, particular vertically. Curve C follows a counterclockwise path around the region bounded by x=-1, x=2, y = 4-x^2, and y = x-2. The region is shaded.](../resources/CNX_Calc_Figure_16_04_204.jpg) </span>
</div>
</div>
...
<span data-type="media" data-alt="A cardioid beginning at the origin, going through (0,1), (-2,0), (0,-1), and back to the origin."> ![A cardioid beginning at the origin, going through (0,1), (-2,0), (0,-1), and back to the origin.](../resources/CNX_Calc_Figure_16_04_205.jpg) </span>
</div>
</div>
<div data-type="exercise">
<div data-type="problem" markdown="1">
...
<span data-type="media" data-alt="A horizontal teardrop-shaped region symmetric about the x axis and a-intercepts at the origin and (3,0). The larger, curved end is at the origin, and the pointed end is at (3,0)."> ![A horizontal teardrop-shaped region symmetric about the x axis and a-intercepts at the origin and (3,0). The larger, curved end is at the origin, and the pointed end is at (3,0).](../resources/CNX_Calc_Figure_16_04_206.jpg) </span>
</div>
<div data-type="solution" markdown="1">
...
<span data-type="media" data-alt="A horizontal oval oriented counterclockwise with vertices at (-2,0), (0,-1), (2,0), and (0,1). The region enclosed is shaded."> ![A horizontal oval oriented counterclockwise with vertices at (-2,0), (0,-1), (2,0), and (0,1). The region enclosed is shaded.](../resources/CNX_Calc_Figure_16_04_207.jpg) </span>
</div>
</div>
<div data-type="exercise">
<div data-type="problem" markdown="1">
